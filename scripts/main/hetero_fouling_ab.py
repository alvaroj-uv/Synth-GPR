...
This differs from scripts/main/peplinski_slope.py, which removed all rocks. Here
...
Workflow:
    python scripts/main/hetero_fouling_ab.py --generate   # writes .in + run_all.bat
    <run run_all.bat through the gprMax conda env>         # produces .out next to each .in
    python scripts/main/hetero_fouling_ab.py --analyze     # slope per arm + delta
