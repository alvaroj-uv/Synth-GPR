...
Usage:
    python scripts/main/rock_vs_homog_rigorous.py --generate
    python scripts/main/rock_vs_homog_rigorous.py --analyze
"""
...
def analyze():
    ...
    def load(p):
        ...
        ez = np.array(f["rxs/rx1/Ez"]).astype(float); f.close()
        return ez, dt
