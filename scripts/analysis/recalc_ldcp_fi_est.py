...
Usage:
    python scripts/analysis/recalc_ldcp_fi_est.py --dir output/gpr_synth_dataset_80k
    python scripts/analysis/recalc_ldcp_fi_est.py --dir output/gpr_synth_dataset_80k --apply
"""
