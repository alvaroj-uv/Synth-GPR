...
Uses 5-fold cross-validation (NOT a single train/test split) because N=36 is
small -- a single split's R^2 would be noisy/unreliable. Reports mean +/- std
across folds and flags this as a small-N feasibility check, not a validated
result (per this project's "test before claiming" convention).
"""
import sys
...
def main():
    ...
    print("\n" + "=" * 60)
    print("5-FOLD CROSS-VALIDATION RESULTS (N=36, SMALL -- feasibility check only)")
    print("=" * 60)
